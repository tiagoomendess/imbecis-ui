<script>
	import { Heading, P, A, Img, List, Li, Button } from 'flowbite-svelte';
</script>
...
<P class="mb-3 text-justify">
	...
	>
	(beta v0.8) por alguém que está farto de ver pessoas egoístas a fazer o que lhes apetece na rua, sem
	qualquer respeito pelo próximo, violando constantemente o código da estrada e os deveres cívicos mais
	básicos sem nenhuma consequência. Esta é uma consequência, e uma forma de tentar educar o condutor
	Português.
</P>
<P class="mb-7 text-justify">
	Explicando o funcionamento da aplicação de forma muito resumida, utilizadores não autenticados na
	internet submetem fotografias de veículos que acham estar estacionados de forma abusiva, e outros
	utilizadores também não autenticados votam se acham que é ou não é um imbecil.
</P>
...
<P class="mb-3 text-justify">
	...
	apagadas permanentemente do servidor, e só existem backups de imbecis confirmados, ou seja, já sem
	metadados. Só mantemos os metadados enquanto eles são estritamente necessários.
</P>
...
<P class="mb-7 text-justify">
	...
	qual era a que lá estava porque não são guardadas copias nem o original. Por isso <b
	...
	>, uma vez que o conteúdo é um campo de texto livre que é preenchido manualmente por utilizadores
	anónimos da internet, que <b>podem inserir o que quiserem</b>, como um comentário numa rede
	social. E a imagem foi irreversivelmente desfocada antes de ser publicada como no Google Maps.
</P>
...
<P class="mb-3 text-justify">
	...
	claramente a matrícula. Em todos os outros casos, com mais ou menos dúvida, clicar em "Não Tenho a
	Certeza".
</P>
...
<P class="mb-3 text-justify">
	Se quiser fazer ainda mais por esta causa para além de enviar e classificar imbecis, pode começar por
	partilhar esta aplicação com os seus amigos e familiares, para que chegue e sensibilize o maior
	número de pessoas possível. Pode ainda fazer download de um cartaz para imprimir e
	colocar em zonas que habitualmente sofrem com o estacionamento abusivo, para chegar também a essas pessoas.
</P>
<div class="flex justify-center mb-3">
	<Button href="/imbecis_cartaz.pdf" target="_blank">Descarregar Cartaz</Button>
</div>
<P class="mb-3 text-justify">
	Pode tambem fazer download de um panfleto para colocar nos parabrisas de carros estacionados de forma abusiva
	depois de os adicionar à aplicação.
</P>
...
<P class="mb-5 text-justify">
	Nos últimos anos, e principalmente desde a pandemia COVID-19, temos assistido a uma degradação do
	tecido social do nosso país. Uma falta de respeito e empatia pelos outros que nos rodeiam, uma
	presunção de que o "meu tempo é mais valioso que o de todos os outros", e uma ideologia parola de
	que existe um direito constitucional de um indivíduo poder levar o seu veículo privado até à porta
	de onde quer que vá, custe o que custar e a quem custar, apenas para evitar de andar 1 minuto a
	pé.
</P>

<P class="mb-5 text-justify">
	Esta mentalidade retrógrada do século passado, leva a que as cidades fiquem mais poluídas, mais
	perigosas para todos fora de um carro, mais desorganizadas, menos eficientes e menos habitáveis. A
	mobilidade de todos é prejudicada por uns poucos que acham que as regras não se aplicam a eles.
</P>

<iframe
	class="mb-5 w-full aspect-[9/16] rounded-lg"
	src="https://www.youtube.com/embed/f5xJ8_VQG88"
	title="ESTACIONAR EM SEGUNDA FILA"
	frameborder="0"
...
<P class="mb-3 text-justify">
	Caminhamos no sentido oposto do progresso, quando as principais economias da europa procuram
	reduzir a dependência do automóvel, nós incentivamos o uso e abuso dele. O que se passa em
	Portugal não acontece nos países mais desenvolvidos e ricos que o nosso, por alguma razão. Existem
	consequências, e nos meses de verão podemos observar Portugueses Emigrantes a fazer cá o que com
	certeza não fazem lá.
</P>

<P class="mb-5 text-justify">
	As nossas cidades cada vez mais parecem cidades de terceiro mundo, de países disfuncionais que não
	conseguem fazer cumprir as próprias leis, onde ninguém cumpre regras de trânsito e se circula a
	monte na via pública, e cede passagem quem tem maior amor ao carro. Uma autêntica selva, uma
...
<P class="mb-3 text-justify">
	Esta não é uma ferramenta de denúncia à polícia, pelo menos por enquanto. Para isso existem estas
	duas aplicações que recomendo: "Aqui Não" e "DenúnciaEstacionamento". No entanto está a ser
	desenvolvida esta funcionalidade e será lançada no futuro.
</P>
...
<P class="mb-3 text-justify">
	...
	ignoram os abusos, perpetuando a impunidade, a falta de respeito e incentivando a continuação do
	ato ilícito. Em variados casos as denúncias enviadas através dos meios legais são ignoradas, não
	resultando em nenhuma consequência para o infrator.
</P>
